...
#SBATCH -o /people/moon515/SLURM_test_broad.out            # Standard output file
#SBATCH -e /people/moon515/SLURM_broad_job_errors_%j.err                # Standard error file, %j will be replaced by job ID
...
python /people/moon515/mpnst_smile_model/deep_TTA_RNA_run.py \
    --data_split_seed 10 \
    --n_epochs 100 \
    --train_omics_input_path /people/moon515/mpnst_smile_model/coderdata_input/broad_sanger_transcriptomics.csv.gz \
    --train_exp_input_path /people/moon515/mpnst_smile_model/coderdata_input/broad_sanger_experiments.tsv \
    --train_drugs_input_path /people/moon515/mpnst_smile_model/coderdata_input/broad_sanger_drugs.tsv \
