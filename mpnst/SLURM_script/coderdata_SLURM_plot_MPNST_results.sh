...
#SBATCH -o /people/moon515/plot_mpnst_check.out  # Standard output file for debugging
#SBATCH -e /people/moon515/plot_mpnst_check_%j.err  # Standard error file, %j will be replaced by job ID
...
python /people/moon515/mpnst_smile_model/evaluate_plot_mpnst_drugs.py \
    --data_split_seed 1 \
    --n_epochs 1 \
    ...
    --checkpoint_path /people/moon515/mpnst_smile_model/models/CCLE_MPNST_dss_model_seed_9_epoch_99.pt \
    # --filter_drugs SMI_8801 \
