...
#SBATCH -J deeptta_run     # Job name for debugging
#SBATCH -o /people/moon515/deeptta_run.out  # Standard output file for debugging
#SBATCH -e /people/moon515/deeptta_run_%j.err  # Standard error file, %j will be replaced by job ID
