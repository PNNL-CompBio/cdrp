...
#SBATCH -J CTRPv1_check     # Job name for debugging
#SBATCH -o /people/moon515/CTRPv1_check.out  # Standard output file for debugging
#SBATCH -e /people/moon515/CTRPv1_check_%j.err  # Standard error file, %j will be replaced by job ID
...
python /people/moon515/mpnst_smile_model/coderdata_auc_deep_TTA_check_self.py \
    ...
    --output_prefix CTRPv1_early_exit \
    --study_description CTRPv1 \
