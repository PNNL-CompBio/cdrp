...
#SBATCH -J deep_TTA       # Job name
#SBATCH -o /people/moon515/deep_TTA.out  # Standard output file
#SBATCH -e /people/moon515/deep_TTA_%j.err  # Standard error file, %j will be replaced by job ID
...
python /people/moon515/mpnst_smile_model/evaluate_epochs.py \
    ...
    --checkpoint_path /people/moon515/mpnst_smile_model/models/ccle_mpnst_model_seed_1_epoch_299.pt
