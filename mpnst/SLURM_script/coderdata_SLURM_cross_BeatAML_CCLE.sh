...
#SBATCH -o /people/moon515/BeatAML_CCLE_check.out  # Standard output file for debugging
#SBATCH -e /people/moon515/BeatAML_CCLE_check_%j.err  # Standard error file, %j will be replaced by job ID
...
python /people/moon515/mpnst_smile_model/coderdata_auc_deep_TTA_cross_test.py \
    --data_split_seed 10 \
    --n_epochs 100 \
    --train_omics_input_path /people/moon515/mpnst_smile_model/2024_05_17/beataml_tpm_transcriptomics.csv.gz \
    ...
    --output_prefix BeatAML_CCLE_aac \
