...
#SBATCH -J beataml     # Job name for debugging
#SBATCH -o /people/moon515/BA_check.out  # Standard output file for debugging
#SBATCH -e /people/moon515/BA_check_%j.err  # Standard error file, %j will be replaced by job ID
...
python /people/moon515/mpnst_smile_model/coderdata_proteomics_deep_TTA_check_self.py \
    --data_split_seed 10 \
    --n_epochs 100 \
    --train_omics_input_path /people/moon515/mpnst_smile_model/2024_05_17/beataml_transcriptomics.csv.gz \
    ...
    --output_prefix BeatAML_Proteomics \
