...
def run_experiment(data_split_seed, bs, lr, n_epochs,
    ...
    data_creater = CreateData(gexp=test_gene_exp_scaled, encoder_type='transformer', metric="ic50", data_path= "shared_input/") # manual change on metric required
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'plots/seed_{data_split_seed}_epoch_{n_epochs}_{output_prefix}_ic50_train_val_plot.png')
