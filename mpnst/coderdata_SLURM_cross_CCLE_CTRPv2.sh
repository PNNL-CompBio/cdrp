...
#SBATCH -J CCLE_CTRPv2     # Job name for debugging
#SBATCH -o /people/moon515/CCLE_CTRPv2_check.out  # Standard output file for debugging
#SBATCH -e /people/moon515/CCLE_CTRPv2_check_%j.err  # Standard error file, %j will be replaced by job ID
...
python /people/moon515/mpnst_smile_model/coderdata_auc_deep_TTA_cross_test.py \
    ...
    --output_prefix CCLE_CTRPv2 \
    --train_study_description CCLE \
    --test_study_description CTRPv2 \
