...
#SBATCH -J CCLE_PRISM     # Job name for debugging
#SBATCH -o /people/moon515/CCLE_PRISM_check.out  # Standard output file for debugging
#SBATCH -e /people/moon515/CCLE_PRISM_check_%j.err  # Standard error file, %j will be replaced by job ID
