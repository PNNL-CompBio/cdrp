...
#SBATCH -J self_beataml     # Job name for debugging
#SBATCH -o /people/jaco059/CoderData_Moon_Project/logs/self_beataml_%j.out  # Standard output file for debugging
#SBATCH -e /people/jaco059/CoderData_Moon_Project/logs/self_beataml_%j.err  # Standard error file, %j will be replaced by job ID
...
python /people/jaco059/CoderData_Moon_Project/cdrp/mpnst/coderdata_auc_deep_TTA_check_self.py \
    ...
    --output_prefix self_beataml \
    --study_description BeatAML \
    --dose_response_metric dss \
    --log_transform True \
    --checkpoint_path /people/jaco059/CoderData_Moon_Project/cdrp/mpnst/tmp/self_beataml_best.pt \
