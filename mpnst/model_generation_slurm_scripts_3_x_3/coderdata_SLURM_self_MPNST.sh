...
#SBATCH -J self_mpnst     # Job name for debugging
#SBATCH -o /people/jaco059/CoderData_Moon_Project/logs/self_mpnst_%j.out  # Standard output file for debugging
#SBATCH -e /people/jaco059/CoderData_Moon_Project/logs/self_mpnst_%j.err  # Standard error file, %j will be replaced by job ID
...
python /people/jaco059/CoderData_Moon_Project/cdrp/mpnst/coderdata_auc_deep_TTA_check_self.py \
    ...
    --output_prefix self_mpnst \
    --study_description MPNST \
    --dose_response_metric dss \
    --log_transform True \
    --checkpoint_path /people/jaco059/CoderData_Moon_Project/cdrp/mpnst/tmp/self_mpnst_best.pt \
