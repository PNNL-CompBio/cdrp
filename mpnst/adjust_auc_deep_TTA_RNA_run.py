...
# def plot_results(true_values, predicted_values): # need to have an option with dose_response_metric
#     plt.figure(figsize=(10, 6))
#     plt.scatter(true_values, predicted_values, alpha=0.5)
#     plt.title('Comparison of True and Predicted fit_AUC')
...
def run_experiment(data_split_seed, bs, lr, n_epochs,
    ...
    # test_exp = average_auc(test_exp) #outdated # need to change to average_dose_response_value at some point as long the mpnst data is consistent.
    ...
    data_creater = CreateData(gexp=test_gene_exp_scaled, encoder_type='transformer', metric="dose_response_value", data_path= "shared_input/") # manual change on metric required
    ...
    for epoch in range(0, n_epochs):
        ...
        val_loss = val_rmse ** 2  # If using RMSE, convert to MSE
