...
#SBATCH -J GDSCv2_check     # Job name for debugging
#SBATCH -o /people/moon515/GDSCv2_check.out  # Standard output file for debugging
#SBATCH -e /people/moon515/GDSCv2_check_%j.err  # Standard error file, %j will be replaced by job ID
...
python /people/moon515/mpnst_smile_model/coderdata_auc_deep_TTA_check_self.py \
    ...
    --output_prefix GDSCv2_early_exit \
    --study_description GDSCv2 \
