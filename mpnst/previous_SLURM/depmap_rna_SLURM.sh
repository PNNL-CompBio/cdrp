...
#SBATCH -J depmap_deep_TTA                  # Job name
#SBATCH -o /people/moon515/SLURM_depmap.out            # Standard output file
#SBATCH -e /people/moon515/SLURM_depmap_job_errors_%j.err                # Standard error file, %j will be replaced by job ID
...
python /people/moon515/mpnst_smile_model/depmap_run_deep_TTA_seed.py 
