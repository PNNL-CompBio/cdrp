...
#SBATCH -o /people/moon515/adjust_ic50_SLURM_test_beataml.out  # Standard output file
...
python /people/moon515/mpnst_smile_model/adjust_ic50_deep_TTA_RNA_run.py \
    --data_split_seed 1 \
    --n_epochs 100 \
