...
#SBATCH -o /people/moon515/SLURM_eval_epoch_ic50.out            # Standard output file
#SBATCH -e /people/moon515/SLURM_eval_epoch_ic50_job_errors_%j.err   # Standard error file, %j will be replaced by job ID
...
python /people/moon515/mpnst_smile_model/evaluate_epochs_ic50.py \
    --data_split_seed 1 \
    --n_epochs 100 \
    ...
    --checkpoint_path /people/moon515/mpnst_smile_model/models/beataml_test_model_seed_1_epoch_19.pt
