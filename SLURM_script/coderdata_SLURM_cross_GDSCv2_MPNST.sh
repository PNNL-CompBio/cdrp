...
#SBATCH -o /people/moon515/GDSCv2_mpnst_check.out  # Standard output file for debugging
#SBATCH -e /people/moon515/GDSCv2_mpnst_check_%j.err  # Standard error file, %j will be replaced by job ID
...
python /people/moon515/mpnst_smile_model/coderdata_auc_deep_TTA_cross_test.py \
    ...
    --output_prefix GDSCv2_MPNST \
    --trai                          7ssss8sqqqzi,,,,,,,,,,,,,,,,,,.............7,,,,,,,,,77g,,,,,,,,,,,,n_study_description GDSCv2 \
