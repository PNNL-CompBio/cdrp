...
#SBATCH -o /people/moon515/CTRPv2_mpnst_check.out  # Standard output file for debugging
#SBATCH -e /people/moon515/CTRPv2_mpnst_check_%j.err  # Standard error file, %j will be replaced by job ID
