...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        os.system(f"python train.py --encoder_type gnn --out_dir GNNenc/{out_dir} --data_version benchmark-data-pilot1  \
        ...
        #os.system(f"python train.py --encoder_type morganfp --out_dir Morganfpenc/{out_dir} --data_version benchmark-data-pilot1  \
